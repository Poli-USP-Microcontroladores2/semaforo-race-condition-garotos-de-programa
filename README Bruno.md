...
4) Analisando o código do meu par, percebe-se que, inicialmente, o programa executa um código com race conditions. O contador, que deveria apontar 2000, aponta 1367, caracterizando uma competição entre as threads. Executando as propostas de testes, percebe-se que, de fato, ocorrem race conditions e imprecisões na contagem. Contudo, em um número significativo de testes, a race condition não foi observada, dado que o contador apontou o valor correto. Nota-se que isso não é um erro das propostas de testes, mas sim uma demonstração da capacidade computacional da placa em contornar esses problemas e calcular os valores certos. Em relação ao código corrigido, todos os testes foram um sucesso. Abaixo, está o link do documento com evidências da testagem do código, foram colocadas quatro fotos, as duas primeiras da testagem do código com race condition e as outras duas sem: 
https://docs.google.com/document/d/1jZPaPzvVJALCGP5LyvjMXlmKpsUKvE8YScFlsRPRt0w/edit?usp=sharing
